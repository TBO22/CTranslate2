...
namespace ctranslate2 {
  namespace ops {
    ...
    template <>
    void LayerNorm::compute<Device::MPS, float>(const StorageView* beta,
      ...
      compute<Device::CPU, float>(beta_cpu.get(), gamma_cpu.get(), input_cpu,
                                  axis, outer_size, axis_size, inner_size, output_cpu);
